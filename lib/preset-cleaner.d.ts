...
export declare const DEFAULT_ISOLATE_GROUP = "compaction";
/**
 ...
 */
export declare function stripIsolateBlock(source: string, groupId: string): {
    text: string;
    removed: boolean;
};
 ...
 */
export declare function purifyPresetPatch(source: string, options?: PurifyOptions): PurifyResult;
/**
 ...
 */
export declare function toModifyRow(source: string): string;
